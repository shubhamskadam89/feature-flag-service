package com.shubhamkadam.feature_flag_service.modules.evaluation.repository;
...
public interface EvaluationRepository extends Repository<Feature, UUID> {
    @Query(
        "SELECT new com.shubhamkadam.feature_flag_service.modules.evaluation.common.FeatureEvaluationData(" +
